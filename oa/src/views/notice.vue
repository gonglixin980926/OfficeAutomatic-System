<template>
	<div>
		...
		<el-button  style="margin:10px 0" type="primary" v-if="isManager()" size="small" icon="el-icon-plus" @click="addGg">新增公告</el-button>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="100px" ref="addForm">
				...
				<el-form-item label="公告内容">
					<el-input type="textarea" :autosize="{minrow:4,maxrow:6}" v-model="addForm.ggnr"></el-input>
				</el-form-item>
			</el-form>
