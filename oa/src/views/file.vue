...
<!--    </el-form>-->
    ...
    <el-table class="fileTable" style="width:100%" :data="tableData">
      ...
      <el-table-column label="操作" width="150">
          ...
          <el-button v-if="isManager()" type="danger" size="small" @click="del(scope.row)" >删除</el-button>
				</template>
			</el-table-column>
    </el-table>
  </div>
...
export default {
  ...
  methods: {
    ...
    down(row) {
      ...
      // }
      window.location.href="http://localhost:8080/file/download?"+'fileName='+row.fileName
